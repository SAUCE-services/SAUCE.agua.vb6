...
Begin VB.Form frmRepPosCort 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Posibles CORTES"
   ClientHeight    =   810
   ClientLeft      =   1410
   ClientTop       =   2805
   ClientWidth     =   4095
   ...
   End
End
Attribute VB_Name = "frmRepPosCort"
...
Dim ctlImp As New clsCtlImpresion
    ...
    For Each clicor In clicor.collectionAll(dbapp)
        ...
        listado.n1 = clicor.clienteID
        listado.c1 = clicor.apellido
        listado.c2 = clicor.nombre
        listado.c3 = clicor.inmuebleCalle
        listado.c4 = Left(clicor.inmueblePuerta & " " & clicor.inmueblePiso & " " & clicor.inmuebleDpto, 25)
        Select Case clicor.cobro
            Case 1:
        ...
        End Select
        If clicor.cobro < 3 Then
            medidor.clienteID = clicor.clienteID
