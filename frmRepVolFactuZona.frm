...
Begin VB.Form frmRepVolFactuZona 
   ...
   End
End
Attribute VB_Name = "frmRepVolFactuZona"
...
Dim facturarep As clsREPFactura
...
Dim impresionService As New clsCtlImpresion
    ...
    Set facturarep = New clsREPFactura
    For Each factura In facturarep.collectionByPeriodoIdAndZona(Me.cboPeriodo.ItemData(Me.cboPeriodo.ListIndex), Me.cboZona.Text)
        DoEvents
    ...
    Next
    Set facturarep = Nothing
    
    Set periodo = periodos("k." & Me.cboPeriodo.ItemData(Me.cboPeriodo.ListIndex))
    
    impresionService.printReport Me.crpFacturas, "rptVolumenZona", dbapp.stringConnection, , , , , _
        ...
        Array("info1", "Período : " & periodo.descripcion & " - Zona : " & Me.cboZona.Text), _
        Array("titulo", "Volumen Facturado por Período y Zona"))
