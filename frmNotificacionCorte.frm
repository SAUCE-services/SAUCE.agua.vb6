...
Begin VB.Form frmNotificacionCorte 
   ...
   End
End
Attribute VB_Name = "frmNotificacionCorte"
...
Dim clientenotifs As Collection
    ...
    For Each cliente In notificacion_service.makeCollectionNotificacionCorte
...
Dim notificacion_service As New clsCtlNotificacion
    ...
    If notificacion_service.makeNotificacionCorte(Me.dtpFecha.value, notificados, dbapp) Then MsgBox "Notificaciones GENERADAS"
...
Dim mens As String
    ...
    impresionService.printReport Me.crpNotificacion, "rptCorteCR", dbapp.stringConnection, , Array(Array("fecha", toReportDate(Me.dtpFecha.value))), , , _
...
Dim clientenotif As New clsMyAClienteNotif
    ...
    Else
        ...
        clientenotif.ultimaNotificacionCorte = Me.dtpFecha.value
