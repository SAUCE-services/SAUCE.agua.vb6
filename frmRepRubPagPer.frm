...
Begin VB.Form frmRepRubPagPer 
   ...
   End
End
Attribute VB_Name = "frmRepRubPagPer"
...
Dim mens As String
    ...
    impresionService.printReport Me.crpReporte, "rptRubroPaga", dbapp.stringConnection, Array("impuestos"), Array(Array("periodoID", Me.cboPeriodo.ItemData(Me.cboPeriodo.ListIndex))), , , _
        ...
        Array("titulo", "Rubros Pagados por Período"))
