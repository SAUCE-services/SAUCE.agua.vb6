...
Begin VB.Form frmRepSociosCF 
   ...
   End
End
Attribute VB_Name = "frmRepSociosCF"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each cliente In clienteRep.collectionSociosActivosConCuotaFija
    ...
    impresionService.printReport Me.crpFacturas, "rptSociosCF", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Socios con CUOTA FIJA"))
