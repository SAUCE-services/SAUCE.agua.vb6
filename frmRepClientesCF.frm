...
Begin VB.Form frmRepClientesCF 
   ...
   End
End
Attribute VB_Name = "frmRepClientesCF"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each cliente In clienteRep.collectionActivosConCuotaFija
    ...
    impresionService.printReport Me.crpFacturas, "rptClientesCF", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Clientes con CUOTA FIJA"))
