...
Begin VB.Form frmRepClientesSM 
   ...
   End
End
Attribute VB_Name = "frmRepClientesSM"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each cliente In clienteRep.collectionActivosConMedidor
        ...
        listado.c5 = cliente.inmuebleLocalidad
    ...
    impresionService.printReport Me.crpFacturas, "rptClientesSM", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Clientes con SISTEMA MEDIDO"))
