...
Begin VB.Form frmNotificacionOC 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Notificación Acta Corte"
   ClientHeight    =   5445
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11070
   ...
   End
End
Attribute VB_Name = "frmNotificacionOC"
...
Dim clientenotifs As Collection
    ...
    For Each cliente In notificacion_service.makeCollectionNotificacionOC
...
Dim notificacion_service As New clsCtlNotificacion
    ...
    If notificacion_service.makeNotificacionOC(Me.dtpFecha.value, notificados, dbapp) Then MsgBox "Notificaciones GENERADAS"
...
Dim mens As String
    ...
    impresionService.printReport Me.crpNotificacion, "rptCorteAC", dbapp.stringConnection, , Array(Array("fecha", toReportDate(Me.dtpFecha.value))), , , _
...
Dim clientenotif As New clsMyAClienteNotif
    ...
    Else
        ...
        clientenotif.ultimaNotificacion48 = Me.dtpFecha.value
