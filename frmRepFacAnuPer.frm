...
Begin VB.Form frmRepFacAnuPer 
   ...
   End
End
Attribute VB_Name = "frmRepFacAnuPer"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each factura In factura.collectionAnuladasByPeriodoID(periodo.periodoId, dbapp)
    ...
    impresionService.printReport Me.crpFacturas, "rptFacturas", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Facturas Anuladas por Período"), _
