...
Begin VB.Form frmRepFacCanPer 
   ...
   End
End
Attribute VB_Name = "frmRepFacCanPer"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each factura In factura.collectionCanceladasByPeriodoID(periodo.periodoId, dbapp)
    ...
    impresionService.printReport Me.crpFacturas, "rptFacturas", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Facturas Canceladas por Período"), _
