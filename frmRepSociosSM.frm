...
Begin VB.Form frmRepSociosSM 
   ...
   End
End
Attribute VB_Name = "frmRepSociosSM"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each cliente In clienteRep.collectionSociosActivosConMedidor
    ...
    impresionService.printReport Me.crpFacturas, "rptSociosSM", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Socios con SISTEMA MEDIDO"))
