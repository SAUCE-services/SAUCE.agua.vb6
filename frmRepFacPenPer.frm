...
Begin VB.Form frmRepFacPenPer 
   ...
   End
End
Attribute VB_Name = "frmRepFacPenPer"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each factura In factura.collectionPendientesByPeriodoID(periodo.periodoId, dbapp)
    ...
    impresionService.printReport Me.crpFacturas, "rptFacturas", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Facturas Pendientes por Período"), _
