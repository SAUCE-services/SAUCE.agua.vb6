...
Begin VB.Form frmRepCortPeriodo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cortes por Período"
   ClientHeight    =   1350
   ClientLeft      =   1410
   ClientTop       =   2805
   ClientWidth     =   6030
   ...
   End
End
Attribute VB_Name = "frmRepCortPeriodo"
...
Dim clientes As Collection
    ...
    For Each suspension In suspension.collectionByPeriodoID("C", Me.cboPeriodo.ItemData(Me.cboPeriodo.ListIndex), dbapp)
    ...
    ctlImp.printReport Me.crpFacturas, "rptSuspen", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Cortes por Período"))
