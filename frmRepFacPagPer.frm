...
Begin VB.Form frmRepFacPagPer 
   ...
   End
End
Attribute VB_Name = "frmRepFacPagPer"
...
Dim impresionService As New clsCtlImpresion
    ...
    For Each factura In factura.collectionPagadasByPeriodoID(periodo.periodoId, dbapp)
    ...
    impresionService.printReport Me.crpFacturas, "rptFacturas", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Facturas Pagadas por Período"), _
