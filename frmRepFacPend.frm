...
Begin VB.Form frmRepFacPend 
   ...
   End
End
Attribute VB_Name = "frmRepFacPend"
...
Dim impresionService As New clsCtlImpresion
    ...
    impresionService.printReport Me.crpFacturas, "rptFPendC", dbapp.stringConnection, , , , , _
        ...
        Array("titulo", "Detalle de Facturas Pendientes"))
