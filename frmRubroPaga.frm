...
Begin VB.Form frmRubroPaga 
   ...
   End
End
Attribute VB_Name = "frmRubroPaga"
...
Dim ctlImp As New clsCtlImpresion
    ...
    ctlImp.printReport Me.crpReporte, "rptRubroPaga", dbmy.stringConnection, Array("impuestos"), Array(Array("periodoID", Me.cboPeriodo.ItemData(Me.cboPeriodo.ListIndex)))
